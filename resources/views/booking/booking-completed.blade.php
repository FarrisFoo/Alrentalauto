                            ...
                            <div class="card-body">
								<div class="border p-4 rounded">
                                    <div class="text-center" style="padding-top: 20px; padding-bottom: 20px;">
                                        <h3 class="">Booking Completed</h3>
                                        <p>Thank you for making a booking with us,<br>any further information will be informed by our admin.</p>
                                        <br><br>
                                        <p>Any question can directly contact our admin on Whatsapp</p>
