<div class="sidebar-wrapper" data-simplebar="true">
            <div class="sidebar-header">
                <div>
                    <img src="{{ asset('assets/images/logo-icon.png') }}" class="user-img" alt="logo icon">
                </div>
                <div>
                    <h4 class="logo-text">Alrentalauto</h4>
                </div>
            ...
            <ul class="metismenu" id="menu">
                <li>
                    <ul>
                        <li> <a href="{{ url('index') }}"><i class="bx bx-right-arrow-alt"></i>Available&nbsp;<span class="badge rounded-pill bg-success"> {{ \App\Models\Car::where('status', 0)->count() }}</span></a>
                        </li>
                        <li> <a href="{{ url('ecommerce') }}"><i class="bx bx-right-arrow-alt"></i>Ongoing&nbsp;<span class="badge rounded-pill bg-primary"> {{ \App\Models\Car::where('status', 1)->count() }}</span></a>
                        </li>
                        <li> <a href="{{ url('alternate') }}"><i class="bx bx-right-arrow-alt"></i>Unavailable&nbsp;<span class="badge rounded-pill bg-danger"> {{ \App\Models\Car::where('status', 2)->count() }}</span></a>
                        </li>
                    </ul>
                </li>
                <li>
                ...
                <li>
                    <a href="{{ route('booking.list') }}">
                        ...
                        <div class="menu-title">Booking Listing</div>
                    </a>
                </li>
                <li>
                    <a href="{{ route('car.list') }}">
                        ...
                        <div class="menu-title">Car Listing</div>
                    </a>
                </li>
                <li>
                    <a href="{{ route('customer.list') }}">
                        ...
                        <div class="menu-title">Customer Listing</div>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin.user-management.listing') }}">
                        ...
                        <div class="menu-title">Admin Listing</div>
                    </a>
                </li>
                <li>
                    <a href="{{ route('booking-form') }}">
                        ...
                        <div class="menu-title">Booking Form</div>
                    </a>
                </li>
